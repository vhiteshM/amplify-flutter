...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    FileSystem_canAccess(_this, path, mode) {
      var exception;
      try {
        _this.accessSync(path, mode);
        return true;
      } catch (exception) {
        return false;
      }
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              ...
              $async$goto = 4;
              return A._asyncAwait(A.Core_withGroup(t2._as(t1.core), "Enable KVM", new A.AvdManager__enableKvm_closure0(), type$.void), $async$_enableKvm$0);
            case 4:
              // returning from await.
              $async$goto = 5;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = self;
              t2 = type$.JSObject;
              if (A.FileSystem_canAccess(t2._as(t1.fs), "/dev/kvm", 6)) {
                $async$returnValue = t2._as(t1.core).info("KVM is already enabled");
                // goto return
                $async$goto = 1;
                break;
              }
            ...
            case 3:
              ...
              t3.runSync$1(A._setArrayType(["sudo", "udevadm", "control", "--reload-rules"], t4));
              t3.runSync$1(A._setArrayType(["sudo", "udevadm", "trigger", "--name-match=kvm"], t4));
              t2._as(t1.core).info("KVM enabled for user");
            case 1:
              // return
              return A._asyncReturn($async$returnValue, $async$completer);
          }
